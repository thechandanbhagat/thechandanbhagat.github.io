        ...
        <div className="profile-container" data-aos="fade-up">
          <div className="profile-card">
            <div className="profile-image">
              <img src="/assets/img/profile-img.jpg" className="img-fluid" alt="Chandan Bhagat" />
              ...
              <div className="profile-info">
                <div className="info-group">
                  <div className="info-item">
                    ...
                    <a href="https://chandanbhagat.com.np" target="_blank" rel="noopener noreferrer">chandanbhagat.com.np</a>
                  </div>
                  
                  <div className="info-item">
                    <i className="fas fa-phone"></i>
                    <strong>Phone</strong>
                    <a href="tel:+447818620731">+44 7818620731</a>
                  </div>
