  ...
  const categories = [
    {
      ...
      items: [
        { icon: <i className="bx bxl-c-plus-plus"></i>, label: 'C# / .NET' },
        { icon: <i className="bx bxl-python"></i>, label: 'Python' },
        { icon: <i className="bx bxl-angular"></i>, label: 'Angular' },
        { icon: <i className="bx bxl-react"></i>, label: 'React' },
      ],
    },
    {
      title: 'Cloud & AI',
      items: [
        { icon: <i className="bx bxl-microsoft"></i>, label: 'Azure' },
        { icon: <i className="bx bx-brain"></i>, label: 'ML.NET' },
        { icon: <i className="bx bx-bot"></i>, label: 'Azure OpenAI' },
        { icon: <i className="bx bx-network-chart"></i>, label: 'TensorFlow' },
        { icon: <i className="bx bx-code-block"></i>, label: 'GroupCode' },
      ],
    },
    {
      title: 'DevOps & Tools',
      items: [
        {
          icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" style={{ fill: '#0563bb' }}>
        ...
        { icon: <i className="bx bxl-kubernetes"></i>, label: 'Kubernetes' },
        { icon: <i className="bx bxl-github"></i>, label: 'GitHub Actions' },
        { icon: <i className="bx bx-cloud"></i>, label: 'Azure DevOps' },
      ],
    },
  ]
            ...
            <div className="skill-category" key={ci}>
              ...
              <div className="skill-grid">
                {cat.items.map((item, ii) => (
                  <div className="skill-item" data-aos="flip-up" key={ii}>
                    {item.icon}
